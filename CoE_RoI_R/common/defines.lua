...
country = {
	...
	BASE_COUNTRY_ADMIN_EFFICIENCY = 1.0,
	...
	BADBOY_LIMIT = 50,
	MAX_BUREAUCRACY_PERCENTAGE = 0.001, -- More than max percent bureaucrats of population will give no additional benefits
	...
	BASE_TARIFF_EFFICIENCY = 0.0, -- baseline tariff efficiency
	...
	SUPPRESSION_POINTS_GAIN_BASE = 150, -- monthly gain with max bureaucrats
	SUPPRESS_BUREAUCRAT_FACTOR = 0.5,
	WRONG_REFORM_MILITANCY_IMPACT = 6,
	...
	COLONIZATION_INFLUENCE_TEMPERATURE_PER_DAY = 0.10,
...
economy = {
	...
	TRADE_CAP_LOW_LIMIT_LAND = 0.75, 				-- the lowest % the slider can go for land units
...
diplomacy = {
	...
	GW_JUSTIFY_CB_BADBOY_IMPACT = 0.75, -- % deduction of infamy cost for justify CB in great war
